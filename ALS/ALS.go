...
// Returns the trained matrix with predictions for 0 valued entries.
...
// Returns the prediction matrix on a scale from 0 to 1.
...
// Returns confidence (float64) for a user/product for the Implicit Case.
